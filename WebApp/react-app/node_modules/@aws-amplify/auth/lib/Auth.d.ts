import { AuthOptions, FederatedResponse, SignUpParams, FederatedUser, ConfirmSignUpOptions, SignOutOpts, CurrentUserOpts, SignInOpts, FederatedSignInOptionsCustom, LegacyProvider, FederatedSignInOptions } from './types';
